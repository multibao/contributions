...
* vous pouvez partager vos ressources sur plusieurs de vos sites en simultané. Si les ressources sont actualisées, les différents sites le seront aussi. 
* en cas de fermeture de votre site/serveur, les données ne seront plus perdues.
...
* vous bénéficiez d'une mise en page travaillée et épurée pour vos ressources, qu'il s'agisse de celles que vous avec publiées ou non.
...
Comment est-ce que je fais concrètement pour choisir ma licence ? Nous vous proposons de choisir une des 6 licences Creative Commons, reconnu par le droit international. Voici [un lien](https://creativecommons.org/choose/?lang=fr) et une vidéo pour vous aider à choisir:
 ...
 * lorsque cette fenêtre s'ouvre, choisissez un nom de dépôt. Choisissez un nom simple qui reflète le réseau / collectif / site que vous représentez
 * dans la description, vous pouvez indiquer vos coordonnées / mail si un lecteur souhaite pouvoir vous joindre
