...
* Action C1: assurer la stabilité financière de la plateforme technologique (2017-2016)
...
> Après une session de conseil et d'accompagnement, +80% des contributeurs ont transposé au moins 1 de leur ressource dans le mois qui suit la session / 1 documentation jugée "très satisfaisante" par +90% des contributeurs. 
> 6 sessions par visioconférence par année, 12 sessions en présentiel par année (apprentissage pair à pair). 

* Action B1: consolider la technologie multiBàO.org dans ses capacités à favoriser la documentation inter-réseaux (2016) 

> Etre arrivé à une version 1.0 d'ici fin 2016 qui ne présente pas de bugs d'utilisation. 

* Action B2: consolider la technologie multiBàO dans sa capacité à se connecter à d'autres supports (2017) 

> 100% de réussite de connexion de multiBàO à des sites utilisant des technologies wikiMedia (ex: Wikipedia, EduTech...) ou wordpress (ex: Démocratie ouverte)
> 15 nouveaux réseaux contributeurs (associatifs et institutionnels)
...
> 100% des ressources publiées sous des licences libres / +30% des participants à des visioconférences sur le sujet qui ne publiaient par leurs ressources sous une licence libre acceptent au minima de publier leurs ressources sous une licence Creative Commons BY-NC-SA. 
> 500 ressources de qualité sous licences libres

* Action C1: assurer la stabilité financière de la plateforme technologique (2017-2019)

> Plateforme technologie 100% entretenue financièrement par les réseaux contributeurs. Le financement de la plateforme devient une ambition collective. 
> Budget annuel de fonctionnement estimé: 40 000€.

### Objectif II - Trouver et documenter des pratiques fortes porteuses d'espoir (2015-2018)

* Action A2: conseiller et accompagner les contributeurs dans la valorisation de leurs savoir-faire (2015-2018)  

> Après une session de conseil et d'accompagnement, +80% des contributeurs ont transposé au moins 1 de leur ressource dans le mois qui suit la session / 1 documentation jugée "très satisfaisante" par la communauté de contributeurs 
> 6 sessions par an.
...
> Avoir rencontré au moins 60 des 80% des réseaux francophones producteurs de données sur les approches collaboratives (francophonie)
...
> +60% des fiches doivent être retrouvées à partir des moteurs de recherche (google, yahoo, bing) lorsqu'un utilisateur qui recherche une ressource y va spécifier sa demande

* Action B4: développement technologique multiBàO.org, favoriser la réappropriation et l'enrichissement des contenus (2016-2017) 

> +50% des contributeurs qui publiaient uniquement sur leurs sites des ressources utilisent le script d'intégration multibao pour faire apparaître les ressources sur leur site web ET les mutualiser avec les autres réseaux sur multiBàO. 
> Au moins 200 sur les 500 contenus font l'objet d'une modification trimestrielle.

* Action B5: favoriser l'intégration de contenus dans les sites webs (2015-2017) 

> 1 documentation jugée "très satisfaisante" par +90% des contributeurs (tutoriels) / 100% des utilisateurs ayant suivi le tutoriel en ligne parviennent à intégrer les contenus multiBàO dans leur site web.  
> +200 sites webs intègrent les ressources de multiBàO sur leurs sites
...
> +30% des ressources numériques désignent des practiciens ou des communautés de pratiques à qui on peut poser des questions ou où l'on peut se former. 
> 150 practiciens et communautés de pratiques mis en avant
